...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2022 at 09:49 PM
...
--
-- Table structure for table `designacaopadonizada`
--
...
--
-- Dumping data for table `designacaopadonizada`
--
...
--
-- Table structure for table `listadesignacaopadronizada`
--
...
--
-- Dumping data for table `listadesignacaopadronizada`
--
...
--
-- Table structure for table `listadesignacaopersonalizada`
--
...
--
-- Dumping data for table `listadesignacaopersonalizada`
--
...
--
-- Table structure for table `listafilme`
--
...
--
-- Dumping data for table `listafilme`
--
...
--
-- Table structure for table `listafilmeconteudo`
--
...
--
-- Dumping data for table `listafilmeconteudo`
--
...
--
-- Indexes for table `designacaopadonizada`
--
...
--
-- Indexes for table `listadesignacaopadronizada`
--
...
--
-- Indexes for table `listadesignacaopersonalizada`
--
ALTER TABLE `listadesignacaopersonalizada`
  ADD PRIMARY KEY (`idListaFilme`);

--
-- Indexes for table `listafilme`
--
...
--
-- Indexes for table `listafilmeconteudo`
--
...
--
-- AUTO_INCREMENT for table `designacaopadonizada`
--
ALTER TABLE `designacaopadonizada`
...
--
-- AUTO_INCREMENT for table `listafilme`
--
ALTER TABLE `listafilme`
  MODIFY `idlistafilme` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
ALTER TABLE `ator`
  ...
  ADD CONSTRAINT `atorpessoa` FOREIGN KEY (`idpessoa`) REFERENCES `pessoa` (`idpessoa`);
...
--
-- Constraints for table `filmegenero`
--
ALTER TABLE `filmegenero`
...
--
-- Constraints for table `listadesignacaopadronizada`
--
ALTER TABLE `listadesignacaopadronizada`
...
--
-- Constraints for table `realizador`
--
ALTER TABLE `realizador`
  ADD CONSTRAINT `realizadorfilme` FOREIGN KEY (`idfilme`) REFERENCES `filme` (`idfilme`),
  ADD CONSTRAINT `realizadorpessoa` FOREIGN KEY (`idpessoa`) REFERENCES `pessoa` (`idpessoa`);

--
-- Constraints for table `visualizacao`
--
ALTER TABLE `visualizacao`
